...
class DatasetProcess:
    ...
    def get_pre_data(self, args):
        ...
        # 没返回
        overal_maxlen = max(train_maxlen, dev_maxlen, test_maxlen)
        return (train_pre_x, train_pre_y, train_pre_prompts), (dev_pre_x, dev_pre_y, dev_pre_prompts), (
            test_pre_x, test_pre_y, test_pre_prompts), vocab, len(vocab)
